...
import 'student_home_search.dart';

import '../components/standard_outlined_button.dart';
import '../components/standard_button.dart';

class StudentHomeContents extends StatefulWidget {
  @override
  _StudentHomeContentsState createState() => _StudentHomeContentsState();
}

class _StudentHomeContentsState extends State<StudentHomeContents> {
